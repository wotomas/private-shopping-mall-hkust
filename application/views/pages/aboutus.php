		  ...
		  <div class="grid_1">
		   <div class="col-md-4 box7">
		   	  <img src="assets/images/test.jpg" class="img-responsive" alt=""/>
			  <br>
		   	  <h3>Web Developer</h3>
		   	  <p>Student: President of KSA</p>
		      <h4>Hobby</h4>   
	          <p>Facebook Youtube Comic Program</p>	   
	          <h4>Previous Projects</h4>   
			  <ul class="column_center">
				<li><a href="#">Data Visualization</a></li>
				<li><a href="#">Chat-Bot</a></li>
				<li><a href="#">Online Used-item Shelter</a></li>
			 </ul>	   
		   </div>
		   <div class="col-md-4 box7">
		   	  <img src="assets/images/test2.jpg" class="img-responsive" alt=""/>
			  <br>
		   	  <h3>Web Maintainer</h3>
		   	  <p>Student: IT manager of KSA</p>
		      <h4>Hobby</h4>   
	          <p>Basketball Study Work</p>	   
			  <h4>Videos</h4>   
		      <ol class="column_center1">
				<li><a href="#">KSA MT Dance Night</a></li>
				<li><a href="#">KSA Basketball Play</a></li>
				<li><a href="#">McDonald Review</a></li>
			  </ol>  
		   </div>
		   <div class="clearfix"> </div>
		 </div>
		 <div class="grid_2">
		 	<h3>Terms of Conditions</h3>
 		 	<p>Terms and Conditions ("Terms") <br />
Last updated: May 26, 2015<br />
Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the http://shop.ustksa.com website (the "Service") operated by HKUSTshop ("us", "we", or "our").<br />
<br />
...
Our Service may contain links to third-party web sites or services that are not owned or controlled by HKUSTshop.<br />
<br />
HKUSTshop has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that HKUSTshop shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.<br />
<br />
...
<br />
Governing Law
These Terms shall be governed and construed in accordance with the laws of Hong Kong, without regard to its conflict of law provisions.<br />
<br />
...
<br />
Changes
We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material we will try to provide at least 15 days notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.<br />
<br />
...
<br />
Our Terms and Conditions agreement was generated by TermsFeed Terms and Conditions Generator (https://termsfeed.com).<br />
<br />
Contact Us<br />
